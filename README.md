...
- [x] Проведена полная визуальная проверка кропов.
- [x] Подключена сильная Teacher-модель.
- [x] Сгенерированы keypoints pseudo-labels.
- [x] Добавлена фильтрация pseudo-labels.
- [x] Собран COCO-like датасет.
- [x] Реализовано обучение Student-модели.
- [x] Подготовлен короткий Kaggle notebook для запуска обучения.
